...
def main():
    new_title = '<p style="font-family:serif; color:black;border-radius:100px ;background-color: orange;text-align: center; font-size: 42px;"><b>Flight Fare Prediction</b></p>'
    ...
    x = "2023" + "/" + str(mon_d) + "/" + str(day_d) + " " + str(hour_1) + ":" + str(minute_1)
    if x is not None:
    ...
    x1 = "2023" + "/" + str(mon_a) + "/" + str(day_a) + " " + str(hour_2) + ":" + str(minute_2)
    if x1 is not None:
